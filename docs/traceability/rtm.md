...
| BRD-REQ-006 | Branch/rooms/vets config | SPR-B005 | TBD | manual | BLOCKED | RFC-0006 propuesto para endpoints/payloads + permisos ROOM/VET |
| BRD-REQ-007 | Agenda CRUD + semana + no-solape sala+vet | SPR-B006, SPR-F003 | TBD | smoke + manual | BLOCKED | RFC-0007 propuesto para contrato appointment; SPR-B005 bloqueado |
