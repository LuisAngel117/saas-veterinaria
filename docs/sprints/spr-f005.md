...
Cerrar exactamente el alcance de SPR-F005 segun docs/sprints/spr-master-front.md, sin ampliar scope y manteniendo UX vendible en espanol.

- **Cierra (master):** BRD-REQ-009
- **Entrega (master):** listado + ficha + edición, consentimientos, búsqueda/paginación básica.
...
- Verificar existencia de este sprint: docs/sprints/spr-f005.md
...
- [ ] Implementado: listado + ficha + edición.
- [ ] Implementado: consentimientos.
...
2) Validar flujo principal de SPR-F005
- Crear/editar cliente con validaciones basicas.
- Registrar consentimiento trazable.
- Buscar y paginar clientes en branch activo.
...
- **Sprint previo de continuidad:** SPR-F004
- **Backend minimo para integrar (RTM):** SPR-B008
