...
Cerrar exactamente el alcance de SPR-F010 segun docs/sprints/spr-master-front.md, sin ampliar scope y manteniendo UX vendible en espanol.

- **Cierra (master):** BRD-REQ-013, BRD-REQ-014, BRD-REQ-016
- **Entrega (master):** UI gestión servicios, edición BOM, captura prescripciones estructuradas, export (HTML/PDF si backend lo expone).
...
### Incluye
- UI gestión servicios.
- edición BOM.
- captura prescripciones estructuradas.
- export (HTML/PDF si backend lo expone).
...
- Catalogo servicios
- Editor BOM
- Formulario prescripcion estructurada
...
- Verificar existencia de este sprint: docs/sprints/spr-f010.md
...
- [ ] Implementado: UI gestión servicios.
- [ ] Implementado: edición BOM.
- [ ] Implementado: captura prescripciones estructuradas.
- [ ] Implementado: export (HTML/PDF si backend lo expone).
- [ ] BRD-REQ objetivo cubierto: BRD-REQ-013, BRD-REQ-014, BRD-REQ-016
...
2) Validar flujo principal de SPR-F010
- CRUD servicio con precio y duracion sugerida.
- Editar BOM por servicio.
- Capturar prescripcion estructurada y export cuando backend lo soporte.
...
- **Sprint previo de continuidad:** SPR-F009
- **Backend minimo para integrar (RTM):** SPR-B013, SPR-B015
