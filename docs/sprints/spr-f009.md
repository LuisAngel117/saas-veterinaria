...
Cerrar exactamente el alcance de SPR-F009 segun docs/sprints/spr-master-front.md, sin ampliar scope y manteniendo UX vendible en espanol.

- **Cierra (master):** BRD-REQ-012
- **Entrega (master):** cerrar atención/HC, reapertura (según permisos), captura reason, mensajes.
...
- Cerrar HC
- Reabrir HC con reason
- Mensajeria de bloqueo edicion
...
- Verificar existencia de este sprint: docs/sprints/spr-f009.md
...
- [ ] Implementado: cerrar atención/HC.
- [ ] Implementado: reapertura (según permisos).
- [ ] Implementado: captura reason.
...
2) Validar flujo principal de SPR-F009
- Cerrar HC y bloquear edicion en UI.
- Reapertura solicita reason y respeta permiso.
- Usuario sin permiso recibe no autorizado.
...
- **Sprint previo de continuidad:** SPR-F008
- **Backend minimo para integrar (RTM):** SPR-B012
