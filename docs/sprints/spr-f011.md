...
Cerrar exactamente el alcance de SPR-F011 segun docs/sprints/spr-master-front.md, sin ampliar scope y manteniendo UX vendible en espanol.

- **Cierra (master):** BRD-REQ-015
- **Entrega (master):** listado productos, stock por branch, movimientos, alertas mínimos, override con reason.
...
- Verificar existencia de este sprint: docs/sprints/spr-f011.md
...
- [ ] Implementado: listado productos.
- [ ] Implementado: stock por branch.
- [ ] Implementado: movimientos.
- [ ] Implementado: alertas mínimos.
- [ ] Implementado: override con reason.
...
2) Validar flujo principal de SPR-F011
- Registrar movimientos y ver impacto en stock.
- Mostrar alertas de minimos.
- Override negativo exige reason y permiso.
...
- **Sprint previo de continuidad:** SPR-F010
- **Backend minimo para integrar (RTM):** SPR-B014
