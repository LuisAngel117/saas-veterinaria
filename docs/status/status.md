...
| SPR-B005 | Config operativa (branches/rooms/vets profiles) | BLOCKED |  | DoR FAIL: RFC-0006 propuesto para endpoints/payloads + permisos ROOM/VET |
| SPR-B006 | Agenda core (CRUD citas + no-solape sala+vet + override) | BLOCKED |  | DoR FAIL: faltan contratos de endpoints/payloads para appointment; dependencias SPR-B005 bloqueadas |
